...
\begin{equation}
M(s,t)\rightarrow M(s,t)+\alpha_{\mathrm{th}}\,\sum_{\ell=0}^{2\left\lfloor\frac{d-4}{2}\right\rfloor}\Delta_\ell(s,t)\,,
\end{equation}
with
$\Delta_\ell(s,t)=\delta_\ell(s,t)+\delta_\ell(t,s)+\delta_\ell(u,t)$, and 
\begin{equation}
\delta(s,t)=
2^{5-d}\,
n_{d,\ell}\,
P_{d,\ell}\left(\frac{t-u}{4-s}\right)\,
