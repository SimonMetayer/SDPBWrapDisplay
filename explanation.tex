...
\end{equation}
These have a nice interpretation in perturbative field theory. Let's consider the EFT of a single massive ($m=1$) field $\phi$ with Lagrangian density
\begin{equation}
\mathcal{L}=
...
\begin{equation}
M(s,t)=-g_0
+\frac{g_2}{\Lambda^4}\left(12+s^2+t^2+u^2-4(s+t+u)\right)
...
\end{aligned}
\end{equation}
Note that the non-perturbative nature of the $c_n$ is manifest as they correspond to an infinite sum of perturbative couplings $g_n$. 
